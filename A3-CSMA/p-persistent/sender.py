...
def sendData(q):
    ...
    while i < len(data):
        ...
        prob = 0.5 #probability by which the sender transmits
        rint = random.randint(0,9)

        #the channel sends with a probability of P
        #it waits for the channel with an probability of (1-p)
        ...
        if(prob*10>rint):
            ...
            print("Waiting for next time slot...")
